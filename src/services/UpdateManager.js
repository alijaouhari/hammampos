...
class UpdateManager {
  ...
  _spawnUpdateScript(zipPath) {
    ...
    const bat = [
      ...
      ':: Force-kill any remaining HammamPOS processes (GPU helper, renderer, etc.)',
      'taskkill /F /IM HammamPOS.exe >nul 2>&1',
      'timeout /t 2 /nobreak >nul',
      ':wait',
      'tasklist /FI "IMAGENAME eq HammamPOS.exe" 2>NUL | find /I "HammamPOS.exe" >NUL',
      'if not errorlevel 1 ( taskkill /F /IM HammamPOS.exe >nul 2>&1 & timeout /t 2 /nobreak >nul & goto wait )',
